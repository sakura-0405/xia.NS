    ...
    <main className={styles.container}>
      ...
      <section className={styles.mainContent}>
        <div className={styles.linkStack}>
          {/* Discord */}
          <Link href="https://discord.gg/PrabXwZtQY" className={`${styles.linkCard} ${styles.discordCard}`}>
            <span className={styles.platform}>Discord</span>
            <span className={styles.username}>豬玀G公園</span>
          </Link>

          {/* Twitch */}
          <Link href="https://www.twitch.tv/sakura_0405" className={`${styles.linkCard} ${styles.twitchCard}`}>
            <span className={styles.platform}>Twitch</span>
            <span className={styles.username}>sakura_0405</span>
          </Link>

          {/* Instagram */}
          <Link href="https://www.instagram.com/sakura._.6896_/" className={`${styles.linkCard} ${styles.instagramCard}`}>
